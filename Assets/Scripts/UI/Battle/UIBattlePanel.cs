...
namespace UI.Battle
{
    class UIBattlePanel : MonoBehaviour
    {
        public CellGrid CellGrid;

        [Header("Panel Unit Info")]
        ...
        private void Awake()
        {
            ...
            NextTurnButton.onClick.AddListener(CellGrid.EndTurn);
            NextTurnButton.onClick.AddListener(RestartLevel);
        }
